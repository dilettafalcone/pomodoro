...
function updateStudyMessage(isLongBreak = false) {
    if (isLongBreak) {
        studyMessageElement.textContent = "Complimenti! Hai completato tutti i cicli!";
    } else {
        studyMessageElement.textContent = "Bene! Adesso pausa!";
    }
}

function resetStudyMessage() {
    studyMessageElement.textContent = "Buon lavoro!";
}
